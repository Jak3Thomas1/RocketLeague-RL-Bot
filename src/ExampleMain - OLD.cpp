...
int main(int argc, char* argv[]) {
    ...
    for (auto& stageConfig : stages) {
        ...
        if (currentStage <= 3) {
            ...
            cfg.ppo.sharedHead.layerSizes = { 256, 256 }; // Keep 256
            cfg.ppo.policy.layerSizes = { 256, 256, 256 }; // Keep 256
            cfg.ppo.critic.layerSizes = { 256, 256, 256 }; // Keep 256
        }
        ...
        cfg.renderMode = true; // Set true for RocketSimVis
